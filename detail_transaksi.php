...
<html>
    ...
    <body>    
            <table class="table table-striped">
                ...
                <?php 
                    $qry_transaksi=mysqli_query($connect,"SELECT * from transaksi join member on transaksi.id_member = member.id where transaksi.id = '".$_GET['id']."'");
                ...
                <tbody style="text-align:center;">
                    <?php 
                    $qry_detail=mysqli_query($connect,"SELECT * from detail_transaksi join paket on detail_transaksi.id_paket = paket.id_paket where detail_transaksi.id_transaksi = '".$_GET['id']."'");
                    $total = 0;
