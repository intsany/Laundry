    ...
    <body>
        ...
        <table class="table table-hover">
            ...
            <tbody style="text-align:center;">
                <?php 
                    include "connect.php";
                    $qry_histori=mysqli_query($connect,"SELECT *,transaksi.id AS id_transaksi from transaksi join member on transaksi.id_member = member.id order by transaksi.id desc");
